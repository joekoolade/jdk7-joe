 ...
 * Provider Class</a> in the "Java Cryptography Architecture API Specification
 * &amp; Reference" for information about how a particular type of provider, the
 * cryptographic service provider, works and is installed. However, please note
 * that a provider can be used to implement any security service in Java that
 * uses a pluggable architecture with a choice of implementations that fit
 * underneath.
 *
 * <p>
 ...
 *
 * <p>
 * The service type <code>Provider</code> is reserved for use by the security
...
public abstract class Provider extends Properties
{
    ...
    /**
     * Returns a human-readable description of the provider and its services. This
     * may return an HTML page, with relevant links.
     *
    ...
    /*
     * override the following methods to ensure that provider information can only
     * be changed if the caller has the appropriate permissions.
     */
     ...
     * this provider. If the default implementation of
     * <code>checkSecurityAccess</code> is used (that is, that method is not
     * overriden), then this results in a call to the security manager's
     * <code>checkPermission</code> method with a
     * <code>SecurityPermission("clearProviderProperties."+name)</code> permission.
     *
     ...
     * mappings will replace any properties that this provider had for any of the
    ...
    /**
     * Sets the <code>key</code> property to have the specified <code>value</code>.
     *
     * <p>
     * First, if there is a security manager, its <code>checkSecurityAccess</code>
     ...
     * overriden), then this results in a call to the security manager's
     * <code>checkPermission</code> method with a
     * <code>SecurityPermission("putProviderProperty."+name)</code> permission.
     *
     ...
     * where <code>name</code> is the provider name, to see if it's ok to remove
     * this provider's properties. If the default implementation of
     * <code>checkSecurityAccess</code> is used (that is, that method is not
     * overriden), then this results in a call to the security manager's
     * <code>checkPermission</code> method with a
     * <code>SecurityPermission("removeProviderProperty."+name)</code> permission.
     *
     * @param key the key for the property to be removed.
     *
     * @return the value to which the key had been mapped, or null if the key did
     *         not have a mapping.
     *
     * @throws SecurityException if a security manager exists and its <code>{@link
     *          java.lang.SecurityManager#checkSecurityAccess}</code> method denies
    ...
    /**
     * Copies all of the mappings from the specified Map to this provider. Internal
     * method to be called AFTER the security check has been performed.
     */
    ...
    /**
     * Remove all invalid services from the Map. Invalid services can only occur if
     * the legacy properties are inconsistent or incomplete.
     */
    ...
    /**
     * Get the service describing this Provider's implementation of the specified
     * type of this algorithm or alias. If no such implementation exists, this
     * method returns null. If there are two matching services, one added to this
     * provider using {@link #putService putService()} and one added via {@link #put
     * put()}, the service added via {@link #putService putService()} is returned.
     *
     * @param type      the type of {@link Service service} requested (for example,
     *                  <code>MessageDigest</code>)
     * @param algorithm the case insensitive algorithm name (or alternate alias) of
     *                  the service requested (for example, <code>SHA-1</code>)
     *
     * @return the service describing this Provider's matching service or null if no
     *         such service exists
     *
     ...
     *
     * <p>
     * Also, if there is a security manager, its <code>checkSecurityAccess</code>
     * method is called with the string <code>"putProviderProperty."+name</code>,
     * where <code>name</code> is the provider name, to see if it's ok to set this
     * provider's property values. If the default implementation of
     * <code>checkSecurityAccess</code> is used (that is, that method is not
    ...
    /**
     * Remove a service previously added using {@link #putService putService()}. The
     * specified service is removed from this provider. It will no longer be
...
//            System.out.println("EngineDesc "+name+" "+paramName);
        }
    ...
    /**
     * The description of a security service. It encapsulates the properties of a
     * service and contains a factory method to obtain new implementation instances
     * of this service.
     *
     * <p>
     * Each service has a provider that offers the service, a type, an algorithm
     * name, and the name of the class that implements the service. Optionally, it
     * also includes a list of alternate algorithm names for this service (aliases)
     * and attributes, which are a map of (name, value) String pairs.
     *
     * <p>
     * This class defines the methods {@link #supportsParameter supportsParameter()}
     * and {@link #newInstance newInstance()} which are used by the Java security
     * framework when it searches for suitable services and instantiates them. The
     * valid arguments to those methods depend on the type of service. For the
     * service types defined within Java SE, see the
     * <a href="../../../technotes/guides/security/crypto/CryptoSpec.html"> Java
     * Cryptography Architecture API Specification &amp; Reference </a> for the
     * valid values. Note that components outside of Java SE can define additional
    ...
    public static class Service
    {
         ...
         * @param attributes Map of attributes or null if this implementation has no
         *                   attributes
         *
         * @throws NullPointerException if provider, type, algorithm, or className is
         *                              null
         */
        ...
        /**
         * Return the value of the specified attribute or null if this attribute is not
         * set for this Service.
         *
         * @param name the name of the requested attribute
         *
         * @return the value of the specified attribute or null if the attribute is not
         *         present
         *
         ...
         *
         * <p>
         * The default implementation uses reflection to invoke the standard constructor
         * for this type of service. Security providers can override this method to
         * implement instantiation in a different way. For details and the values of
         * constructorParameter that are valid for the various types of services see the
         * <a href="../../../technotes/guides/security/crypto/CryptoSpec.html"> Java
         * Cryptography Architecture API Specification &amp; Reference</a>.
         *
         * @param constructorParameter the value to pass to the constructor, or null if
         *                             this type of service does not use a
         *                             constructorParameter.
         *
         * @return a new implementation of this service
         *
         * @throws InvalidParameterException if the value of constructorParameter is
         *                                   invalid for this type of service.
         * @throws NoSuchAlgorithmException  if instantiation failed for any other
         *                                   reason.
         */
...
//                System.out.println("Provider new cap:"+cap+" type:"+type+" class:"+cap.constructorParameterClassName);
//                System.out.println("EngineDesc "+cap.name + " consParam "+constructorParameter);
                if (cap == null)
                {
...
//                    System.out.println("Provider implClass " + clazz);
                    Class<?>[] empty =
                    {};
                    Constructor<?> con = clazz.getConstructor(empty);
//                    System.out.println("Provider con name " + con.getName());
            ...
            {
                throw new NoSuchAlgorithmException("2 Error constructing implementation (algorithm: " + algorithm
                        + ", provider: " + provider.getName() + ", class: " + className + ")", e.getCause());
            } catch (Exception e)
            {
//                System.out.println("Provider exc: " + e.getMessage());
                e.printStackTrace();
                throw new NoSuchAlgorithmException("1 Error constructing implementation (algorithm: " + algorithm
        ...
        /**
         * Generic code path for unknown engine types. Call the no-args constructor if
         * constructorParameter is null, otherwise use the first matching constructor.
         */
        private Object newInstanceGeneric(Object constructorParameter) throws Exception
        {
            ...
            throw new NoSuchAlgorithmException(
                    "No public constructor matching " + argClass.getName() + " found in class " + className);
        }

        /**
         * Test whether this Service can use the specified parameter. Returns false if
         * this service cannot use the parameter. Returns true if this service can use
         * the parameter, if a fast test is infeasible, or if the status is unknown.
         *
         * <p>
         * The security provider framework uses this method with some types of services
         * to quickly exclude non-matching implementations for consideration.
         * Applications will typically not need to call it.
         *
         * <p>
         * For details and the values of parameter that are valid for the various types
         * of services see the top of this class and the
         * <a href="../../../technotes/guides/security/crypto/CryptoSpec.html"> Java
         * Cryptography Architecture API Specification &amp; Reference</a>. Security
         * providers can override it to implement their own test.
         *
         * @param parameter the parameter to test
         *
         * @return false if this this service cannot use the specified parameter; true
         *         if it can possibly use the parameter
         *
         * @throws InvalidParameterException if the value of parameter is invalid for
         *                                   this type of service or if this method
         *                                   cannot be used with this type of service
         */
         ...
         * Parses the attributes if not yet initialized.
         */
